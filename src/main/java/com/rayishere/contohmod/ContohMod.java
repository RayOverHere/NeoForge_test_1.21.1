...
import com.rayishere.contohmod.item.ModCreativeModeTabs;
...
public class ContohMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "easyenderpearl";
    ...
    public ContohMod(IEventBus modEventBus, ModContainer modContainer) {
